        ...
        orders.forEach(order => {
            if (order.order_side === 'BUY') {
                buyOrders.push({
                    ...
                    asset: decimal_js__WEBPACK_IMPORTED_MODULE_7__["Decimal"].div(this.form.value.amountPerGrid, parseFloat(order.order_price)).toNumber().toFixed(this.precisionAmount),
...
let DashboardComponent = class DashboardComponent {
    ...
    ngOnInit() {
        this.historyService.getHistorys().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1)).subscribe(histories => {
            this.history = histories;
        });
        const self = this;
        this.interval = setInterval(() => {
            self.historyService.getHistorys().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1)).subscribe(histories => {
...
HistorysService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
